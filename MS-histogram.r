...
main <- function(){
    ...
    ackley_results2 <- replicate(50, multi_start(ackley_function, domain2, num_points = 100,dimensions2))
    rastring_results2 <- replicate(50, multi_start(rastrigin_function, domain2, num_points = 100,dimensions2))
    ackley_results10 <- replicate(50, multi_start(ackley_function, domain10, num_points = 100,dimensions10))
    rastring_results10 <- replicate(50, multi_start(rastrigin_function, domain10, num_points = 100,dimensions10))
    ackley_results20 <- replicate(50, multi_start(ackley_function, domain20, num_points = 100,dimensions20))
    rastring_results20 <- replicate(50, multi_start(rastrigin_function, domain20, num_points = 100,dimensions20))
